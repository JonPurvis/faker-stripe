...
| API Resource                                                                                 | Method                                          | Example                                                                                                                                                                                            |
|----------------------------------------------------------------------------------------------|-------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Credit Balance Transactions](https://stripe.com/docs/api/credit-balance-transaction)        | `stripeBillingCreditBalanceTransactionId()`     | `cbtxn_37b3DSyi5lc9uck2sp1hs0on`                                                                                                                                                                  |
| [Credit Grants](https://stripe.com/docs/api/credit-grant)                                    | `stripeBillingCreditGrantId()`                  | `credgr_37b9KW82CDhSi5lcuk1hs0on`                                                                                                                                                                  |
...
| [Usage Records Summary](https://stripe.com/docs/api/usage-record-summary)                    | `stripeBillingUsageRecordSummaryId()`                  | `mbur_ppVgDLt5HcG8zP48Grk7NZfP`                                                                                                                                                                    |
